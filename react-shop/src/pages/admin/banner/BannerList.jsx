...
import BannerService from '../../../services/BannerService'; // Import service
...
export default function BannerList() {
    ...
    return (
        <> {/* Sử dụng Fragment */}
            ...
            {/* Bảng dữ liệu - Giống ProductList */}
                            ...
                            filteredBanners.map((banner, index) => (
                                <tr key={banner.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="p-3 border-b">
                                        {banner.imageUrl ? (
                                            <img src={`${IMAGE_BASE_URL}${banner.imageUrl}`}
                                                alt={banner.name || 'Banner'}
                                                className="h-16 w-32 object-contain rounded-md bg-gray-100" // object-contain
                                            />
                                        ) : (
